...
- **[CSOAI OSCAL Generator + Layer-0](https://github.com/CSOAI-ORG/oscal-generator-mcp)** — Open-source MCP server that generates machine-readable NIST OSCAL packages (SSP / component-definition) and **Ed25519-signs** them as offline-verifiable EU AI Act Article-12 evidence. Validates under [compliance-trestle](https://github.com/oscal-compass/compliance-trestle); ships a browser-based, no-account verify page. Flagship of a governed-MCP fleet that uniquely bridges **legacy systems** (COBOL/SAP/SCADA/HL7/ISO-20022) modern agent-governance tools do not reach. Apache-2.0.
